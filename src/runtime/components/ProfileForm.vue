    ...
    <template #header>
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
          <span v-if="hasChanges" class="text-sm text-amber-600 dark:text-amber-400 font-medium">
    ...
    <div class="space-y-8">
      ...
      <UForm :schema="profileSchema" :state="form" @submit="handleSubmit" class="space-y-8">
        <UCard variant="subtle" class="mb-6">
          ...
          <UFormField label="Full Name" name="full_name" class="flex items-center justify-between mb-4 gap-2">
            <UInput
          ...
          <UFormField label="Email Address" name="email" required class="flex items-center justify-between not-last:pb-4 gap-2">
            <UInput
              v-model="form.email"
              type="email"
              disabled
        ...
        <div class="flex items-center justify-between mb-4 gap-2">
          ...
          <div class="flex-1">
            <UInput
              ...
              size="md"
            />
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Must be at least 8 characters with numbers and letters.</p>
          </div>
        </div>
...
// Get auth state
const { currentUser, getProfile, updateProfile, getAvatarFallback } = useTeamAuth()
...
// Get submit button text - always "Save Profile" but different enabled states
