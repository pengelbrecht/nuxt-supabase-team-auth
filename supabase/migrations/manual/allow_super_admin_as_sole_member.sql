-- Manual Migration: Allow super_admin to replace sole owner
--
-- This fixes the constraint that prevents changing a sole owner to super_admin.
-- Super_admin is recognized as a privileged role that can manage teams without
-- requiring the "owner" designation.
--
-- How to apply:
